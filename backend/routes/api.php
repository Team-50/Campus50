...
$router->group(['prefix'=>'v1','middleware'=>'auth:api'], function () use ($router)
{
	...
	$router->post('/keuangan/transaksi-pengembangan',['middleware'=>['role:superadmin|keuangan'],'uses'=>'Keuangan\TransaksiBiayaPengembanganController@index','as'=>'transaksi-pengembangan.index']);
	$router->post('/keuangan/transaksi-pengembangan/store',['middleware'=>['role:superadmin|keuangan'],'uses'=>'Keuangan\TransaksiBiayaPengembanganController@store','as'=>'transaksi-pengembangan.store']);
	$router->put('/keuangan/transaksi-pengembangan/{id}',['middleware'=>['role:superadmin|keuangan'],'uses'=>'Keuangan\TransaksiBiayaPengembanganController@update','as'=>'transaksi-pengembangan.update']);
	$router->delete('/keuangan/transaksi-pengembangan/{id}',['middleware'=>['role:superadmin|keuangan'],'uses'=>'Keuangan\TransaksiBiayaPengembanganController@destroy','as'=>'transaksi-pengembangan.destroy']);
